...
- [itr-wala](https://github.com/karanb192/itr-wala) - Prepares Indian income tax returns (ITR-1 to 4) with a deterministic tax engine; the LLM reads documents, tested Python does all the math.
