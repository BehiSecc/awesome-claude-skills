...
- [comfortable-roadtrip-planner](https://github.com/CrazyRiceMaker/comfortable-roadtrip-planner) - Comfort-first road trip / 自驾路书 Agent Skill. Plans around fixed hotels and limited stamina, then outputs a one-file HTML route app with A/B/C stops, maps, meals, tickets, and calendar import.
