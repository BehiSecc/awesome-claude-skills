...
- [multi-code-review](https://github.com/szarkans/multi-code-review) - consensus code review: Claude + OpenAI Codex (+ optional Google Antigravity) review the same diff in parallel, findings reconciled into one report. 
