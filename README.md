...
- [Pathmode](https://github.com/pathmodeio/claude-plugin/tree/main/skills) - Nine skills for the spec you hand a coding agent: draft it, pressure-test its weakest claims, run a deterministic six-gate readiness check before code is written, split it into issues, and review the diff against the outcomes it promised. Keyless, no account.
