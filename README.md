...
- [lizard-skill](https://github.com/lizard-build/skill) - Teaches an agent to deploy and manage apps on Lizard through its CLI; the guide is loaded from the installed CLI at runtime so it always matches the version.
