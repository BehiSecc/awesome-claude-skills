...
- [claude-code-coach](https://github.com/jonathanlesh/claude-code-coach) - Subagent and best practices guide for turning lessons, corrections, and workflows into the right `.claude/` artifacts. Includes a coach agent and comprehensive reference guide.
