...
- [breakthrough-harness](https://github.com/GuoCheng24/breakthrough-harness) - Research-discipline skill that keeps agent-run experiments honest: null models scored first, calibration/held-out separation, claim-polarity gate, and guards that must be shown to fail; includes two runnable numpy demos.
