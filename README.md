...
- [agent-skill-groups](https://github.com/go165/agent-skill-groups) - Scenario-profile manager for loading only the Claude Code and Agent Skills groups needed for a task.
