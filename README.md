...
- [Floe Agent Skills](https://github.com/Floe-Labs/agent-skills) - Metered, budget-capped multi-vendor API access (LLM, STT, TTS, telephony, search, data) through one key, with per-call cost attribution and server-side spend limits.
