...
- [zero-slop](https://github.com/manavmishra/ZeroSlop) - Score any draft 0-100 for AI-sounding language with an offline scorer, then rewrite it without adding or dropping a fact. Zero runtime dependencies.
