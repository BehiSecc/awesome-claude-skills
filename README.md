...
- [i-hate-editing](https://github.com/ranahaani/i-hate-editing) - Turns raw talking-head takes into a finished cut with local whisper.cpp, ffmpeg, and a 67-rule craft playbook.
