...
- [vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template/tree/main/.claude/skills) - Six planning skills that turn an idea into a PRD, a technical design, and the AGENTS.md instruction files an agent builds from.
