...
- [webcmd](https://github.com/agentrhq/webcmd) - Per-site browser skills for Claude Code via `webcmd skills add`: learns a site's navigation once, then exposes it as deterministic CLI commands.
