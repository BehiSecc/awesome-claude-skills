...
- [MandateGuard](https://github.com/ezequiellich44-cmd/MandateGuard) - Deterministic, auditable payment policy for AI agents: budgets, allowlists, denylists, per-window rate limits, and signed Ed25519 mandates enforced before any money-moving tool executes - no LLM in the decision path. Tamper-evident SHA-256 ledger, MCP server on the official MCP Registry.
