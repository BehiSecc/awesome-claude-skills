...
- [Birdview](https://github.com/Qiuner/birdview) - As agents write more code, programming shifts toward architecture and constraints. Birdview makes both reviewable before implementation through source-backed maps, declared change scope, and recorded verification.
