...
- [mailtrap-skills](https://github.com/mailtrap/mailtrap-skills) - Agent skills for Mailtrap covering email sending via API/SMTP, sandbox testing for dev/staging, domain setup (SPF/DKIM/DMARC), and contacts management.
