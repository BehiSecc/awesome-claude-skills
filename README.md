...
- [AgentScan](https://github.com/thesfb/scanaskill) - Deterministic local scanner for AI agent skills: detects prompt injection, secrets, network calls, and malware patterns before install. Never runs the skill, works offline.
