...
- [unflat](https://github.com/merturl4576/unflat) - Give flat AI-built landing pages depth with one reversible CSS block derived from the site's own colors: a ground, one light source, mounted surfaces, and a trace of the site's own atmosphere; no markup changes.
