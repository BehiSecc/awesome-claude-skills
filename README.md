...
- [job-application-agent](https://github.com/vaibhavarora14/job-application-agent) - Privacy-first Agent Skill for discovering, evaluating, completing, and tracking your own job applications with verified facts only.
