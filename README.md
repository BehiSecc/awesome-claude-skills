...
- [aws-architecture-diagram-skill](https://github.com/vidanov/aws-architecture-diagram-skill) - Generate production-quality AWS architecture diagrams as editable draw.io files with 270+ verified icons, left-to-right layout, and PNG/SVG/PDF export. Works with Claude Code, Kiro CLI, ChatGPT, and any AI agent.
