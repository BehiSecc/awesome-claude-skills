...
- [harness-evolver](https://github.com/raphaelchristi/harness-evolver) - LangSmith-native autonomous agent optimization. Multi-agent proposers evolve prompts, routing, tools, and architecture in isolated git worktrees with regression guards and evolution memory.
