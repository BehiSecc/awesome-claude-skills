...
- [seo-check](https://github.com/AnTIdoTe003/claude-seo-check) - Pre-commit SEO audit: reviews pending git changes for SEO regressions (noindex, robots.txt, canonicals, redirects, JSON-LD) and crawls the affected routes as Googlebot before you commit.
