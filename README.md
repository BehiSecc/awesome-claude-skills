...
- [omen-development](https://github.com/panbanda/omen/tree/main/plugins/development) - Code analysis skills backed by the Omen MCP server: find bugs, assess change impact, plan refactors and audit architecture.
