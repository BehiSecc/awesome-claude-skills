...
- [noveum-ai](https://github.com/Noveum/noveum-skill/tree/main/noveum-ai) - Set up agent tracing, verify trace completeness, build evaluation datasets, and investigate failures with the Noveum platform.
