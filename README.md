...
- [codachi](https://github.com/vincent-k2026/codachi) - Tamagotchi-style statusline pet for Claude Code. Grows with context usage, reacts to tool executions via hooks, tracks cache efficiency, and predicts when you'll hit the context limit. Install via `npx codachi init`.
