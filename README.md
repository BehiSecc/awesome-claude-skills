...
- [repo-cover](https://github.com/sjh9714/repo-cover) - Design GitHub social-preview cards (og:image) as one self-contained HTML file with four editorial moods, CJK-first typography, and deterministic design checks.
