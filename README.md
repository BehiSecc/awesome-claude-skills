...
- [MemClaw](https://github.com/Felo-Inc/memclaw) - Persistent project memory for AI coding agents. Creates isolated memory workspaces per project with a web dashboard for reviewing and managing what your AI remembers. Free to use.
