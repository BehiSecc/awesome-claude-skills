...
- [skill-rollcall](https://github.com/Londopy/skill-rollcall) - Diagnoses why a skill is not registering or triggering, lints descriptions, audits skill contents, and fixes folder layouts. Works as a skill or a stdlib-only CLI.
