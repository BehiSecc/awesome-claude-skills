...
- [awesome-bug-bounty](https://github.com/YangTech-gh/Awesome-Bug-Bounty) - Authorized bug-bounty hunting skill: recon methodology, vulnerability playbooks (XSS, SSRF, IDOR, SQLi), payloads, business-logic checks, and tool guidance.
