...
- [mentionagent-claude-skill](https://github.com/BuildsbyMatt/mentionagent-claude-skill) - Link building outreach through the MentionAgent MCP server: review the drafted pitches, approve only the ones you name, answer publisher replies and close placements from Claude Code, Cursor or OpenCode.
