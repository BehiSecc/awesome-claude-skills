...
- [codachi](https://github.com/vincent-k2026/codachi) - Tamagotchi-style statusline pet for Claude Code. Grows with context usage, reacts to tool executions via hooks, tracks cache efficiency and context velocity, and predicts time until context is full. 850+ mood messages, 5 species, 10 color palettes.
