...
| **[cue-omni-reader](https://github.com/sensedeal/cue-skills/tree/main/cue-omni-reader)** | Parse web pages (including in-page video/attachments), PDFs (scanned & text-layer), audio, and video into Markdown. Install: `npx skills add sensedeal/cue-skills --skill cue-omni-reader` (MIT; may bill). *By [@sensedeal](https://github.com/sensedeal)* |
