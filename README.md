...
- [unified-ai-gateway](https://github.com/happy520ai/unified-ai-system/tree/master/skills/unified-ai-gateway) - Operate a self-hosted AI + MCP gateway from an agent: provider-free prompt enhancement, health and readiness, budget and governance inspection, on a credential-free fake-provider default path.
