...
- [perfectify](https://github.com/dankofly/perfectify) - Self-improving control kernel for coding agents (DAGx AGI Kernel): hard approval stops before irreversible actions, evidence-gated completion, and a self-learning playbook with drift governance. Behaviorally evaluated, harness-portable (Claude Code, Codex, Hermes, OpenCode).
