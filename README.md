...
- [jev-assist](https://github.com/glud123/jev-assist) - Ranks every file in a repo by relevance to a task before the agent starts reading, checks convention drift, and gates diffs as a pre-commit hook — with a validate command that measures ranking accuracy against your git history.
