...
- [screenpipe-api](https://github.com/screenpipe/screenpipe/tree/main/crates/screenpipe-core/assets/skills/screenpipe-api) - Query locally recorded screen, audio, meetings, and UI context from Claude.
