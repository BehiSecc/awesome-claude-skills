...
- [claude-carbon](https://github.com/gwittebolle/claude-carbon) - Tracks the CO2 footprint of Claude Code sessions with a live status line, session reports, and shareable PNG report cards.
