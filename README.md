...
- [pm-claude-skills](https://github.com/mohitagw15856/pm-claude-skills) - 454 professional Agent Skills across 65 bundles and 25 professions (PRDs, sprint plans, exec updates, contracts, pitch decks, health scorecards, GTM plans, financial models, and more), curated eval suite with a public leaderboard, and Workflow Recipes that chain skills end-to-end. Runs in Claude Code, ChatGPT, Gemini, Cursor, Codex, and Hermes; free browser playground (no key needed), MCP (local + hosted), npm, and pip install.
