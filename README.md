...
- [SkillAgent](https://skillagent.dev) - Free directory of ~3,500 agent skills, rules files and MCP servers from GitHub with safety scans, freshness checks and quality scores.
