...
- [repo-context-ledger](https://github.com/gviiisen/repo-context-ledger/tree/main/skills/repo-context-ledger) - Preserve verified repository context across Claude Code, Codex, Cursor, and other coding agents with scoped Context Packs and cross-session handoffs.
